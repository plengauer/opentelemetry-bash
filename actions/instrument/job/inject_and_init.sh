...
if [ "$(printf '%s' "$GITHUB_JOB_ID" | wc -l)" -le 1 ]; then "Guessing GitHub job id to be $GITHUB_JOB_ID" >&2; export GITHUB_JOB_ID; else echo ::warning ::Could not guess GitHub job id.; fi
