...
# observe
observe_rate_limit() {
  used_gauge_handle="$(otel_counter_create standard counter github.api.rate_limit.used 1 "The amount of rate limited requests used")"
  remaining_gauge_handle="$(otel_counter_create standard counter github.api.rate_limit.remaining 1 "The amount of rate limited requests remaining")"
  while true; do
