...
The project is named after [Thoth](/https://en.wikipedia.org/wiki/Thoth), the egyptian god of the Moon, wisdom and knowledge (aka observability), writing and hieroglyphs (aka shell scripts), science, magic, art and judgment of the dead (aka troubleshooting).
