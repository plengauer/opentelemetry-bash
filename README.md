...
If the command is just a wrapper for another command (e.g., sudo, xargs, parallel, ...), OpenTelemetry will automatically be injected into the inner command to continue observation as well.
